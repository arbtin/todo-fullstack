    ...
    <div className='border-b border-gray-900/10 pb-12'>
      <form>
        <div className='sm:col-span-4'>
          ...
          <input type='text' className='bg-white-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5' required
